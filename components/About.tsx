...
export default function About({ t }: Props) {
  return (
    <section id="about" className="py-[var(--section-pad)] px-[var(--gutter)]">
      <div className="max-w-[1240px] mx-auto">
        <div className="grid gap-14 min-[880px]:grid-cols-[1.15fr_0.85fr] min-[880px]:gap-20 items-start">
          ...
          <div className="min-[880px]:order-1 flex flex-col gap-10">
            ...
            {/* Facts row */}
            <div
              className="reveal grid grid-cols-2 gap-px bg-white/8 border border-white/8 rounded-[14px] overflow-hidden min-[720px]:grid-cols-4 self-start"
              style={{ '--delay': '0.2s' } as React.CSSProperties}
            >
              {t.facts.map((f) => (
                <div key={f.k} className="flex flex-col gap-1 p-[18px_22px] bg-bg">
                  <span className="font-mono text-[11px] uppercase tracking-[0.1em] text-fg-dim">{f.k}</span>
          ...
          {/* Portrait column */}
          <div
            className="min-[880px]:order-2 sticky top-[100px] flex flex-col gap-3.5 reveal"
          ...
          >
            <div className="relative aspect-[4/5] bg-bg-elev border border-white/8 rounded-[14px] overflow-hidden group transition-all duration-500 hover:border-white/[16%] hover:-translate-y-[3px]">
              ...
              {/* Placeholder content */}
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-gradient-to-br from-bg-elev-2 to-bg">
            ...
            <div className="flex justify-between font-mono text-[10px] text-fg-dim uppercase tracking-[0.1em]">
              <span>/ portrait</span>
              <span>2026</span>
            </div>
          </div>
